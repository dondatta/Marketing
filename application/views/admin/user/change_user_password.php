	...
	<section class="content">
		<div class="box box-info custom_box">
			<div class="box-header">
				<h3 class="box-title"><i class="fa fa-pencil"></i> <?php echo $this->lang->line("Reset User's Password");?> <?php echo " [ ".$member_name." ]"; ?></h3>
			</div><!-- /.box-header -->
			<!-- form start -->
				...
				<div class="box-footer">
					<div class="form-group">
						<div class="col-sm-12 text-center">
							...
							<input type="button" class="btn btn-default btn-lg" value="<?php echo $this->lang->line('Cancel'); ?>" onclick='goBack("user/index")'/>  
						</div>
					</div>
				</div><!-- /.box-footer -->         
			</div><!-- /.box-info -->       
