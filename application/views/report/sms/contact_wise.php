...
<section class="content-header">
  <h1><?php echo $this->lang->line('My SMS Report');?> </h1>  
</section>
  ...
  <div class="row">
    <div class="col-xs-12">
        <div class="grid_container">
            ...
            url="<?php echo base_url()."report/sms_report_contactwise_data"; ?>" 
            pagination="true" 
            rownumbers="true" 
            toolbar="#tb" 
            pageSize="10" 
            ...
            >
                ...
                <thead>
                    <tr>      
                       ...
                       <th field="to_number" sortable="true" ><?php echo $this->lang->line('Mobile'); ?></th>
       ...
       <div id="tb" style="padding:3px"> 
          <a target="_blank" class="btn btn-warning"  title="Download" href="<?php echo site_url('report/download_sms_report_contactwise');?>">
