...
<section class="content-header">
  <h1> <?php echo $this->lang->line("Users' Email Report"); ?> </h1>  
</section>
  ...
  <div class="row">
    <div class="col-xs-12">
        <div class="grid_container">
            ...
            url="<?php echo base_url()."report/email_report_userwise_data"; ?>" 
            pagination="true" 
            rownumbers="true" 
            toolbar="#tb" 
            pageSize="10" 
            ...
            >
                ...
                <thead>
                    <tr>      
                       ...
                       <!-- <th field="company" sortable="true" >Company Name</th> -->
                       ...
                       <th field="total_email_sent" sortable="true" ><?php echo $this->lang->line('Total Email Sent'); ?></th>
                    </tr>
                </thead>
            </table>                        
         </div>
       ...
       <div id="tb" style="padding:3px"> 
          <a target="_blank" class="btn btn-warning"  title="Download" href="<?php echo site_url('report/download_email_report_userwise');?>">
