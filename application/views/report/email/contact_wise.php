  ...
  <div class="row">
    <div class="col-xs-12">
            ...
            >
                ...
                <thead>
                    <tr>      
                       ...
                       <th field="to_email" sortable="true" ><?php echo $this->lang->line('To Email'); ?></th>
       ...
       <div id="tb" style="padding:3px"> 
          <a target="_blank" class="btn btn-warning"  title="Download" href="<?php echo site_url('report/download_email_report_contactwise');?>">
