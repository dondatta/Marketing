		...
		if($api_key!="" && $this->session->userdata("user_type")=="Admin") { ?>
			<div id = 'facebook_check'>
				...
				<div class="well" style="background:#F9F2F4;margin-top:0;border-radius:0;;">
					<?php echo "curl ".site_url("ssem_api/send_notification")."/".$api_key; ?>
				</div>
			</div>
			...
			<div id = 'facebook_check'>
				<h4 style="margin:0">
					<div class="alert alert-info" style="margin-bottom:0;">
						<i class="fa fa-clock-o"></i> Schedued/Birthday-wish SMS/Email Cron Job Command 
					</div>
				</h4>
				<div class="well" style="background:#F9F2F4;margin-top:0;border-radius:0;;">
			...
			<div id = 'facebook_check'>
				<h4 style="margin:0">
					<div class="alert alert-info" style="margin-bottom:0;">
						<i class="fa fa-clock-o"></i> Schedued/Email Cron Job Command 
					</div>
				</h4>
				<div class="well" style="background:#F9F2F4;margin-top:0;border-radius:0;;">
					<?php echo "curl ".site_url("ssem_api/scheduler_email")."/".$api_key; ?>
				</div>
			</div>
			...
			<div id = 'facebook_check'>
				<h4 style="margin:0">
					<div class="alert alert-info" style="margin-bottom:0;">
						<i class="fa fa-clock-o"></i> Schedued/SMS Cron Job Command 
					</div>
				</h4>
				<div class="well" style="background:#F9F2F4;margin-top:0;border-radius:0;;">
					<?php echo "curl ".site_url("ssem_api/scheduler_sms")."/".$api_key; ?>
				</div>
			</div>
		<?php }?>
