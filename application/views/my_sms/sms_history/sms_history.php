...
<section class="content-header">
  <h1><?php echo $this->lang->line('My SMS History');?> </h1>  
</section>
...
<script type="text/javascript">
	...
	function action_column(value,row,index){
		...
		var sms_history_info=JSON.stringify(row);
		  ...
		  str="<a title='View Contacts' style='cursor:pointer' onclick='view_details(event,"+sms_history_info+")' >" +' <img src="<?php echo base_url("plugins/grocery_crud/themes/flexigrid/css/images/magnifier.png");?>" alt="View">'+"</a>";
   		return str;
	}
