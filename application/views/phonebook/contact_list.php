...
<section class="content">  
  <div class="row" >
    <div class="col-xs-12">
       ...
       <a class="btn btn-warning"  title="Add Contact" href="<?php echo site_url('phonebook/add_contact');?>">
            <i class="fa fa-plus-circle"></i> <?php echo $this->lang->line('Add'); ?>
       </a>

        <button type="button" class="btn btn-warning pull-right" id = "url_with_email_wise_download_btn" style = 'margin-right:10px'><i class="fa fa-cloud-download"></i><?php echo $this->lang->line('Export'); ?></button>
...
<script> 
    ...
    {             
        ...
        str=str+"&nbsp;&nbsp;&nbsp;&nbsp;<a style='cursor:pointer' onclick='return confirm(\""+delete_str+"\")' title='"+'Delete'+"' href='"+delete_url+"'>"+' <img src="<?php echo base_url("plugins/grocery_crud/themes/flexigrid/css/images/close.png");?>" alt="Delete">'+"</a>";
