...
class setting extends Home
{
    ...
    public function edit_config()
    {
        ...
        if ($_POST) {
            // validation
            $this->form_validation->set_rules('institute_name',       '<b>'.$this->lang->line("Company Name").'</b>',       'trim|required|xss_clean');
            $this->form_validation->set_rules('institute_address',    '<b>'.$this->lang->line("Company Address").'</b>',    'trim|xss_clean');
            $this->form_validation->set_rules('institute_email',      '<b>'.$this->lang->line("Company Email").'</b>',      'trim|xss_clean|valid_email');
            $this->form_validation->set_rules('institute_mobile',     '<b>'.$this->lang->line("Company Mobile").'</b>',     'trim|xss_clean');
